...
**版本：1.0 ；更新时间：2022-7-31；作者：jlgulu**
...
Notepad++是Windows操作系统下的一套[文本编辑器](https://baike.baidu.com/item/文本编辑器/8853160) ，功能强大，可以免费使用，自带中文，支持众多计算机程序语言。

下载链接 ：https://appsitory.com/windows/notepad-plus-plus/
...
Web前端开发基础知识学习路线分享，前端开发入门学习三大基础：**HTML、CSS、JavaScript**
...
AJAX 是一种在无需重新加载整个网页的情况下，能够更新部分网页的技术。Vue 是一套用于构建用户界面的渐进式框架。
...
SSH(struts+spring+hibernate)是一个集成框架，可帮助开发人员在短期内搭建可靠的Web应用程序。Struts作为系统的整体基础架构，负责MVC的分离与控制业务跳转；Hibernate框架对持久层提供支持；Spring做管理，管理struts和hibernate。
...
基于SSM实现的个人博客系统，适合初学SSM和个人博客制作的同学学习。主要涉及技术包括的包括[Maven](https://so.csdn.net/so/search?q=Maven&spm=1001.2101.3001.7020)，Spring，SpringMVC，MyBatis，Redis，JSP等。
